...
@Component({
  selector: 'app-spring-logs',
  templateUrl: './spring-logs.component.html',
  styleUrls: ['./spring-logs.component.scss']
})
export class SpringLogsComponent {
  jobLogData: any = [];
  ...
  pageInd = 0;
  constructor(
    private dialogRef: MatDialogRef<SpringLogsComponent>,
    @Inject(MAT_DIALOG_DATA) public data: any,
    private jobService: SpringJobService
  ) {}
