...
import { MessageUserService, MetadataConfigService } from 'src/app/services';
import { Location } from '@angular/common';
import { NgForm } from '@angular/forms';

@Component({
  selector: 'app-metadata-copy',
  templateUrl: './metadata-copy.component.html',
  styleUrls: ['./metadata-copy.component.scss']
})
export class MetadataCopyComponent implements OnInit {
