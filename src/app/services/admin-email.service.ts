...
export class AdminEmailService {
  ...
  private apiUrl: string = environment.apiUrl + 'admin/emailConfig';
  ...
  putAdminEmailConfig(obj: any, id:any) {
    return new Observable((observable) => {
  ...
  createAdminEmailConfig(obj: any) {
    return new Observable((observable) => {
